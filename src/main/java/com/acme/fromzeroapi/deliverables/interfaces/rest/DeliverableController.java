...
public class DeliverableController {
    ...
    @PostMapping
    public ResponseEntity<CreateDeliverableResource> createDeliverable(@RequestBody CreateDeliverableResource resource) {
        ...
        return new  ResponseEntity<>(createdDeliverableResource, HttpStatus.CREATED);
    }
